    ...
    protected void buildApp(){
        ...
        withDraw1.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent event) {
                if(balance >= 5){
                    balance = balance - 5;
                    displayArea.setText("<html>\u20B95 Withdrawal! <br><br>" + finishedTransaction() + "</html>");
                    readyToEnter = false;
                    System.out.println("User Has Withdrawal \u20B95");
                    updateTransactionHist("User Has Withdrawl \u20B95");
                } else {
                    displayArea.setText("<html> Your Balance is below \u20B95. Unable to Withdrawal!! <br><br>"
        ...
        withDraw2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent event) {
                if(balance >= 1000){
                    ...
                    displayArea.setText("<html>\u20B91000 Withdrawal! <br><br>" + finishedTransaction() + "</html>");
                    readyToEnter = false;
                    System.out.println("User Has Withdrawl \u20B91000");
                    updateTransactionHist("User Has Withdrawl \u20B91000");
                } else {
                    displayArea.setText("<html> Your Balance is below \u20B910. Unable to Withdrawal!! <br><br>"
                            + finishedTransaction() + "</html>");
                }
        ...
        withDraw3.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent event) {
                if(balance >= 20){
                    balance = balance - 20;
                    displayArea.setText("<html>\u20B920 Withdrawal! <br><br>" + finishedTransaction() + "</html>");
                    readyToEnter = false;
                    System.out.println("User Has Withdrawal \u20B920");
                    updateTransactionHist("User Has Withdrawal \u20B920");
                } else {
                    displayArea.setText("<html> Your Balance is below \u20B920. Unable to Withdrawal!! <br><br>"
                            + finishedTransaction() + "</html>");
                }
            }
        });
